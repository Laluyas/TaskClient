...
import { Modal, Box, Button, TextField, FormControl, InputLabel, Select, MenuItem, Grid } from '@mui/material';
...
const AddTaskModal = ({ open, handleClose }) => {
  ...
  useEffect(() => {
    ...
    if (open) { // Fetch users only when the modal is opened
      fetchUsers();
    }
  }, [open]);
  ...
  const handleSubmit = async (event) => {
    ...
    const selectedUserIDs = assignedTo.map(email => {
